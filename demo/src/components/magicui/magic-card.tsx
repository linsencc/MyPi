/**
 * Magic UI — Magic Card（官方源码）
 * 适配：移除 next-themes，固定为浅色治愈系界面（orb 使用 multiply）。
 * 来源: https://github.com/magicuidesign/magicui — apps/www/registry/magicui/magic-card.tsx
 */
