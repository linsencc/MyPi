...
export type UnitScheduleFormState = {
...
/** 校验周期定时表单；失败时返回错误文案 */
export function validateScheduleForm(form: UnitScheduleFormState): string | null {
...
export function applyScheduleFormToUnit(u: Unit, form: UnitScheduleFormState): Unit {
